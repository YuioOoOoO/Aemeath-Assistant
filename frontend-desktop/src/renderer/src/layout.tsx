...
export const layoutStyles = {
  ...
  windowsTitleBar: {
    ...
    height: '30px',
    backgroundColor: 'rgba(23, 19, 29, 0.97)',
    borderBottom: '1px solid rgba(249, 205, 222, 0.13)',
    paddingLeft: '20px',
    paddingRight: '10px',
    zIndex: 1000,
  ...
  titleBarButton: {
    ...
    _hover: { backgroundColor: 'rgba(235, 181, 205, 0.18)', color: '#9E5F7B' },
  },
  closeButton: {
    size: 'sm',
    variant: 'ghost',
