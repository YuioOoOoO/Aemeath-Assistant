...
function SettingUI({ open, onClose }: SettingUIProps): JSX.Element {
  ...
  return (
    <DrawerRoot
      ...
      placement="start"
    >
      <DrawerBackdrop {...settingStyles.settingUI.drawerBackdrop} />
      <DrawerContent {...settingStyles.settingUI.drawerContent}>
        ...
        <DrawerFooter {...settingStyles.settingUI.drawerFooter}>
          <Button {...settingStyles.settingUI.secondaryButton} onClick={handleCancel}>
            {t('common.cancel')}
          </Button>
          <Button {...settingStyles.settingUI.primaryButton} onClick={handleSave}>
            {t('common.save')}
          </Button>
        </DrawerFooter>
      </DrawerContent>
