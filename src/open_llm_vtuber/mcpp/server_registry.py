...
class ServerRegistry:
    ...
    def load_servers(self) -> None:
        ...
        for server_name, server_details in servers_config.items():
            ...
            # `python` always means the interpreter currently running the backend.
            # This also works in the self-contained packaged runtime where console
            # script shims such as uvx are intentionally not bundled.
            if command == "python":
