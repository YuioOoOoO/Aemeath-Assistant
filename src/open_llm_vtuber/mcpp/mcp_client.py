...
class MCPClient:
    ...
    async def _ensure_server_running_and_get_session(
        ...
        # MCP's stdio helper otherwise uses a restricted default environment.
        # Preserve PYTHONPATH so subprocesses launched by the packaged backend can
        # import dependencies from resources/backend/site-packages.
